...
Public Class new_quote
    ...
    Private Sub finalise_quotation_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles finalise_quotation.Click
        ...
        Try
            ...
            cmd.CommandText = "INSERT INTO quo_master values(@id,@cust,@datya,@sub,@orderf,@totya,@dis,@nflat,@sid,'','','','','','',0,12.36,@quote,1)"
            cmd.Prepare()
...
dhinchak:
            Dim x1 As String
            x1 = InputBox("Is any discount applicable - (0 if none ) ", "Discount")
            ...
            cmd.Parameters.AddWithValue("@quote", newid)
            cmd.ExecuteNonQuery()
...
eend:
    ...
    Private Sub remind_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles remind.Click
